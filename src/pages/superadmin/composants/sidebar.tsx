...
const SuperadminSidebar = () => {
  ...
  const navItems = [
    { path: '/superadmindashboard', label: 'Dashboard', icon: <FaChartBar /> },
    { path: '/superadmincolis', label: 'Gestion des colis', icon: <FaBox /> },
    { path: '/Users', label: 'Utilisateurs', icon: <FaUsers /> },
    { path: '/Agences', label: 'Agences', icon: <FaMapMarkedAlt /> },
    { path: '/superadminsuivi', label: 'Suivi colis', icon: <FaTruck /> },
    { path: '/superadminhistorique', label: 'Historique', icon: <FaHistory /> },
        ...
        <div className="text-center mb-4 px-3">
          <div className="logo-container mb-3">
            <div className="app-logo bg-white rounded-circle mx-auto d-flex align-items-center justify-content-center" style={{ width: '60px', height: '60px' }}>
              <span className="text-orange fw-bold fs-4">SM</span>
            </div>
          </div>
          {!collapsed && <h5 className="fw-bold text-white">Super Admin</h5>}
        </div>
